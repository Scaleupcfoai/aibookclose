...
export const closeChecklist = [
  ...
  },
  {
    ...
    reviewer: 'u1', reviewStatus: null, priority: 'critical', reconId: 'intercompany-prism',
  },
  {
    id: 't22e', phase: 'reconciliation', task: 'Accrued Liabilities — Schedule vs GL',
    owner: 'u2', dueDate: '2026-04-06', status: 'not_started', completedAt: null,
    reviewer: 'u1', reviewStatus: null, priority: 'high', reconId: 'accrued-liabilities',
  },
  {
    id: 't22f', phase: 'reconciliation', task: 'Payroll Recon — Salary Register vs GL',
    owner: 'u5', dueDate: '2026-04-06', status: 'not_started', completedAt: null,
    reviewer: 'u2', reviewStatus: null, priority: 'medium', reconId: 'payroll-recon',
  },
